#C:/SENTINELAAPOLO/SentinelaApolo/settings.py
...
WSGI_APPLICATION = 'SentinelaApolo.wsgi.application'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Deve corresponder ao volume no Docker
